...
<body>
    ...
    <div class="carousel-inner caro">
        <div class="caro1 carousel-item active">
            <video src="images/mairpods.mp4" class=" vid object-fit-scale" autoplay loop muted></video>
    ...
    <section class="cardproducts">
        <div class=" con container-lg">
            <div class="card card1">
                ...
                <img src="images/air1.jpg" class="card-img-top" alt="...">
                <div class="top-left">
            ...
            <div class="card card2">
                <img src="images/air2.jpg" class="card-img-top" alt="...">
                <div class="top-left">
            ...
            <div class="card card3">
                <img src="images/air3.jpg" class="card-img-top" alt="...">
                <div class="top-left">
        ...
        <div class=" con1 container-lg">
            ...
            <div class="products">
                <div class="card pcard1">
                    <img src="images/aiara.png" class="card-img-top pimg1">
                    <div class="card-body">
                ...
                <div class="card pcard2">
                    <img src="images/airb.png" class="card-img-top pimg2" alt="...">
                    <div class="card-body">
            ...
            <div class="closer">
                <h2>Why Apple is the best<br> place to buy Airpods</h2>
            </div>
    ...
    <!-- essentials -->
    <div class="essen">
        <h2>Watch essentials.</h2>
    </div>
    <div class="esscard">
        <div class="card cardes1">
            <div class="card-body">
                <h5 class=" car card-title">Watch accessories</h5>
                <p class="pcar card-text">Explore colourful cases, USB‑C power adapters, MagSafe accessories and more..</p>
        ...
        <div class="card cardes2">
            <div class="card-body">
                ...
                <p class="pcar1 card-text">Attach one to your keys. Put another in your backpack. If they’re misplaced, just use the Find My app</p>
    ...
    <div class=" foo container-fluid">
        ...
        <div class="footer">
            ...
            <div class="col footer1">
                <h4 class="foos">Explore Airpods</h4>
            ...
            <div class="col footer1">
                <h4 class="foos">Shop Airpods</h4>
                <h1 class="foot">Shop Airpods</h1>
                <h1 class="foot">Airpods Accessories</h1>
                <h1 class="foot">Apple Trade In</h1>
                <h1 class="foot">Ways to Buy</h1>

            </div>
            <div class="col footer1">
                <h4 class="foos">More from Airpods</h4>
                <h1 class="foor">Airpods Support</h1>
